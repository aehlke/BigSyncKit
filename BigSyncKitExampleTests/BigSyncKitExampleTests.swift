//
//  BigSyncKitTests.swift
//  BigSyncKitTests
//
//  Created by Alex Ehlke on 2021-10-09.
//
...
import CloudKit
import BigSyncKit
@testable import BigSyncKitExample

class BigSyncKitExampleTests: XCTestCase, RealmSwiftAdapterDelegate {
    ...
    func testRecordsToUpload_whenRecordWasDownloadedForObject_usesCorrectRecordVersion() {
        ...
        let data = try! Data(contentsOf: Bundle(for: BigSyncKitExampleTests.self).url(forResource: "QSCompany.1739C6A5-C07E-48A5-B83E-AB07694F23DF", withExtension: "")!)
    ...
    func testOldToken_preserved() {
        ...
        let data = try! Data(contentsOf: Bundle(for: BigSyncKitExampleTests.self).url(forResource: "serverChangeToken.AQAAAWPa1DUC", withExtension: nil)!)
